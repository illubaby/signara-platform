"""Package Compare router following Clean Architecture.

Thin HTTP layer handling package compare page rendering.
...
from app.domain.package_compare.entities import FormConfig

router = APIRouter(tags=["package_compare"])
...
@router.get("/package-compare", response_class=HTMLResponse)
async def package_compare_page(request: Request):
    """Render the package compare page.
    ...
    return templates.TemplateResponse(
        "package_compare.html",
        {
            "request": request,
            "title": "Package Compare",
            "page_id": "package-compare",
